...
export function validate(input){
  ...
  if(parseInt(input.height_min) >= parseInt(input.height_max)){
    ...
    // document.getElementById('height_min').innerText=" ";
    //document.getElementById('height_max').innerText=" ";
  ...
  return (
    <section className={style.container}>
      ...
      <form onSubmit={handleSubmit} className={style.formul}>
        ...
        <div>History: {[input.temperament.map(i => valueTemp.find(       v => v.id === i     )?.name )]}</div>
        <div>Selected value =
          {valueTemp.find(
